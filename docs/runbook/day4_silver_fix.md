...
- **Day 4 Task 4.1~4.3 (Silver→Gold 5분 텀블링 + 데이터 신선도 SLO + DuckDB 검증)**: [`day4_silver_to_gold.md`](./day4_silver_to_gold.md) — 본 runbook 의 silver fix 위에서 진행된 후속. plan 코드 보강 6건 진단도 포함
...
- 트러블슈팅 archive
    ...
    - [`2026-05-08-day-4-silver-fix-resolved.md`](../portfolio/troubleshooting/2026-05-08-day-4-silver-fix-resolved.md) — Day 4 Task 1 silver streaming silent commit fail 해결 (7 단계 진단 + ClassLoader fix + 5 학습 패턴)
    - [`2026-05-09-day-4-tasks-4_1-4_3.md`](../portfolio/troubleshooting/2026-05-09-day-4-tasks-4_1-4_3.md) — Day 4 Task 4.1~4.3 plan 코드 보강 6건 진단 (silver_stream_wm watermark 우회 / DuckDB UUID 경로 / SLO p95 414→393 / spec review 단계 식별)
- 이전 runbook
